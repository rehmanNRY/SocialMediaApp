          ...
          <ul className="grid grid-cols-1 gap-6">
            {receivedRequests.map((user) => (
              ...
              >
                ...
                <div className="flex items-center space-x-4">
                  <button
                    className="flex items-center px-5 py-3 text-base font-medium text-white bg-green-500 rounded-full hover:bg-green-600 transition duration-300"
                  ...
                  <button
                    className="flex items-center px-5 py-3 text-base font-medium text-white bg-red-500 rounded-full hover:bg-red-600 transition duration-300"
                  ...
                  <Link href={`profile/${user.sender._id}`}>
                    <button
                      className="flex items-center px-5 py-3 text-base font-medium text-blue-600 border border-blue-600 rounded-full hover:bg-blue-50 transition duration-300"
                      title="View Profile"
                    >
