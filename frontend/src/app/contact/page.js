    ...
    <AuthRedirect>
      ...
      >
        <div className="w-full max-w-6xl mx-auto text-center py-20">
          ...
          <button className="">
            <a target='_blank' href="https://rehman-nry.netlify.app/" className="px-8 py-4 bg-blue-500 text-white font-semibold rounded-full shadow-md hover:bg-blue-600 hover:shadow-xl transition-all duration-300 mt-12 flex items-center">
              Visit Portfolio
              <span className='ml-2'><FiExternalLink /></span>
            </a>
          </button>
        </div>
      </main>
